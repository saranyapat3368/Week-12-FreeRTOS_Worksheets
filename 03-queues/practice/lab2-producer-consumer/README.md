...
|-------|-----------|-----------|----------|----------|---------|------------|
| 1 | 3 | 2 | 120 | 115 | 5 | 90% | สมดุลใกล้เคียง ปริมาณสินค้าคงค้างเล็กน้อย |
| 2 | 4 | 2 | 160 | 130 | 30 | 81% | Queue เริ่มเต็มบ่อยครั้ง มี drop มากขึ้น |
| 3 | 3 | 1 | 90 | 60 | | 30 | 66% | Consumer ไม่ทัน ทำให้สินค้า drop มาก |

### คำถามสำหรับการทดลอง
1. ในทดลองที่ 2 เกิดอะไรขึ้นกับ Queue?
- ปริมาณสินค้าใน Queue เพิ่มขึ้นเร็วกว่าอัตราการบริโภค → Queue มีแนวโน้มเต็มบ่อยครั้ง
2. ในทดลองที่ 3 ระบบทำงานเป็นอย่างไร?
- Queue เริ่มเต็มเร็ว → มีสินค้า drop จำนวนมาก → ความสมดุลของระบบเสียไป
